...
@section('content')
    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>{{ trans('messages.EDIT POST') }}</h2>
                </div>
                <div class="body">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <label class="form-label">{{ trans('messages.Post Title') }}</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="published">{{ trans('messages.Published') }}</label>
                    </div>
                    <hr>
                    <div class="form-group">
                        <label for="">{{ trans('messages.Body') }}</label>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>{{ trans('messages.SELECT CATEGORY') }}</h2>
                </div>
                <div class="body">

                    <div class="form-group form-float">
                        <div class="form-line {{$errors->has('categories') ? 'focused error' : ''}}">
                            <label for="categories">{{ trans('messages.Select Category') }}</label>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{$errors->has('tags') ? 'focused error' : ''}}">
                            <label for="tags">{{ trans('messages.Select Tag') }}</label>
                    ...
                    <img class="img-responsive thumbnail" src="{{Storage::url('posts/'.$post->image)}}" alt="">
                        <label for="form-label">{{ trans('messages.Featured Image') }}</label>
                    ...
                    <button type="submit" class="btn btn-indigo btn-lg m-t-15 waves-effect">
                        ...
                        <span>{{ trans('messages.UPDATE') }}</span>
                    </button>
