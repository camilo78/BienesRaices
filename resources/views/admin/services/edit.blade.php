        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header bg-indigo">
                    <h2>{{ trans('messages.EDIT SERVICE') }}</h2>
                </div>
                <div class="body">
                    <form action="{{route('admin.services.update',$service->id)}}" method="POST">
                        ...
                        <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <label class="form-label">{{ trans('messages.Service Title') }}</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <label class="form-label">{{ trans('messages.Service Icon') }}</label>
                                </div>
                                <small>{{ trans('messages.To get icons name list just click the link:') }} <a href="https://materializecss.com/icons.html" target="_blank">Materialize Icon</a></small>
                            </div>
    
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="number" name="service_order" class="form-control" min="1" value="{{ $service->service_order }}">
                                    <label class="form-label">{{ trans('messages.Service Order') }}</label>
                                </div>
                            </div>
