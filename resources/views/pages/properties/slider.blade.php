    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:850px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
        ...
        <!-- Arrow Navigator -->
        <div data-u="arrowleft" class="jssora106" style="width:55px;height:55px;top:350px;left:30px;" data-scale="0.75">
        ...
        <div data-u="arrowright" class="jssora106" style="width:55px;height:55px;top:350px;right:30px;" data-scale="0.75">
            <svg viewBox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
                <circle class="c" cx="8000" cy="8000" r="6260.9"></circle>
