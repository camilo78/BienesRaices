                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="input-group input-group-lg mt-3">
                                        ...
                                        <input id="username" name="username" type="text" placeholder="{{ trans('messages.Username') }}" value="{{ $profile->username ? $profile->username : '' }}" class="form-control rounded-0">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="input-group input-group-lg mt-3 ">
                                        ...
                                        <input id="email" name="email" type="email" placeholder="{{ trans('messages.Email') }}" value="{{ $profile->email }}" class="form-control rounded-0">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="input-group input-group-lg mt-3">
