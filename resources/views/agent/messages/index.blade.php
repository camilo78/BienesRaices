                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($message->status == 0)
                                            <a href="{{route('agent.message.read',$message->id)}}" class="btn btn-warning btn-sm rounded-0">
                                                <i class="fas fa-book-reader text-white"></i>
                                            </a>
                                            @else
                                            <a href="{{route('agent.message.read',$message->id)}}" class="btn btn-success btn-sm rounded-0">
                                                <i class="fas fa-check text-white"></i>
                                            </a>
                                            @endif
                                            <a href="{{route('agent.message.replay',$message->id)}}" class="btn btn-primary btn-sm rounded-0">
