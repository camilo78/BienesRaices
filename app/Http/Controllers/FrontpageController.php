...
class FrontpageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.home.index', compact('settings','sliders','properties','features','services','testimonials','posts'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('pages.search', compact('properties','settings'));
    }
